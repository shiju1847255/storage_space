...
<html lang="en">
	...
	<link rel="stylesheet" type="text/css" href="storageshow.css">
...
<?php
		...
		$sql3="SELECT * from address where  address2_id='$addressID'" ;
          ...
          echo "<div class='container' id='storageInfo' style='background-color:white;opacity:0.8;'>
			  ...
			  <div class='row'>
				<div class='col-sm-6 col-md-6 col-lg-6'>
                    <div class='row'>
                        <div class='col-md-6'>
                            <h4><strong>Renter</strong></h4>
                        </div>
                        <div class='col-md-6'>
                            <h4>".$row2['first_name']." ".$row2['last_name']."</h4>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-6'>
                        ...
                        <div class='col-md-6'>
                            <h4>".$row['storage_size']."</h4>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-6'>
                            <h4><strong>Storage Type </strong></h4>
                        </div>
                        <div class='col-md-6'>
                            <h4>".$row['storage_type']."</h4>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-6'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-6'>
                            <h4>".$row3['house_flat_no']." , ".$row3['street_colony']." , ".$row3['city']." , ".$row3['state']." , Pin: ".$row3['pincode']." , Landmark: ".$row3['land_mark']."</h4>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-6'>
                            <h4><strong>Storage Suitable For </strong></h4>
                        </div>   
                        <div class='col-md-6'>
                        ";
				...
				<div class='col-sm-6 col-md-6 col-lg-6'>
                    <div class='row'>
                         <div class='col-md-6'>
                            <h4><strong>Available From </strong></h4>
                        </div>
                        <div class='col-md-6'>
                    ...
                    <div class='row'>
                         <div class='col-md-6'>
                            <h4><strong>Available Till </strong></h4>
                        </div>
                        <div class='col-md-6'>
                            <h4>".$row['stop_date']."</h4>
                        </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-6'>
                           <h4> ".$row['payment_method']."</h4>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-6'>
                            <h4><strong>Rent Per Week </strong></h4>
                        </div>
                        <div class='col-md-6'>
                           <h4> ".$row['rent']."</h4>
                        </div>
                    ...
                    <div class='row'>
                        <div class='col-md-6'>
                            <h4><strong>Security Features </strong>
                        </div>
                        <div class='col-md-6'>
                            ";
			...
			foreach($files as $file){
			  ...
			  echo"</div><br><br>";
              if($customerID==$std){
                echo "<button class='btn btn-success btn-lg pull-right disabled'>Book</button>";
              }
              else{
                echo "<button class='btn btn-success btn-lg pull-right' onclick=window.location.href='bookstorage.php?cvalue=$customerID&bvalue=$storageID'>Book</button>";
              }
              echo"<button class='btn btn-primary btn-lg pull-right' onclick=window.location.href='search.php'>Go Back</button>
